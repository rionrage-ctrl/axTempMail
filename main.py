...
MAIN_KB = ReplyKeyboardMarkup(
    keyboard=[
        [KeyboardButton(text="✅ Get Mail", style=ButtonStyle.SUCCESS)],
        [
            KeyboardButton(text="👤 Profile", style=ButtonStyle.DANGER),
            KeyboardButton(text="📥 Inbox", style=ButtonStyle.PRIMARY),
        ],
    ],
